    ...
    write(
        ...
        "\n".join(
            [
                ...
                "        RustWorker { name: name.to_string() }",
                "    }",
                "",
                "    pub fn run(&self) -> String {",
                "        rust_helper(&self.rust_name())",
                "    }",
                "}",
                "",
                "pub fn rust_helper(value: &str) -> String {",
                "    value.to_string()",
                "}",
                "",
                "pub fn rust_entry() -> String {",
                "    let worker = RustWorker::new(\"api\");",
                "    worker.run()",
                "}",
                "",
            ]
    ...
    write(
        ...
        "\n".join(
            [
                ...
                "}",
                "",
                "class JavaWorker implements JavaNamed {",
                "    private final String name;",
                "",
                "    JavaWorker(String name) {",
                "        this.name = name;",
                "    }",
                "",
                ...
                "",
                "    public String run() {",
                "        return JavaHelpers.decorate(javaName());",
                "    }",
                "}",
                "",
                "class JavaHelpers {",
                ...
                "class App {",
                "    String javaEntry() {",
                "        JavaWorker worker = new JavaWorker(\"api\");",
                "        return worker.run();",
                "    }",
                "}",
                "",
    ...
    write(
        ...
        "\n".join(
            [
                ...
                "class CppNamed {",
                "public:",
                "    virtual std::string cppName() const = 0;",
                "};",
                "",
                "class CppWorker : public CppNamed {",
                "public:",
                ...
                "        return cppHelper(cppName());",
                "    }",
                "};",
                "",
                "std::string cppHelper(const std::string& value) {",
                "    return value;",
                "}",
                "",
                "std::string cppEntry() {",
